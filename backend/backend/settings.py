...
INSTALLED_APPS = [
    ...
    'corsheaders', # add this middleware to make django REST API
    'rest_framework', # add this middleware to make django REST API
    'todo',
]
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # add this middleware to make django REST API
]
